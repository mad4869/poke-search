...
const PokeCard: React.FC<PokeCardProps> = ({ pokemonName, selectPokemon }) => (
    <div
        ...
        className="flex flex-col items-center justify-center p-4 text-sm transition-transform bg-white rounded-lg shadow-md cursor-pointer sm:text-base text-primary shadow-primary/20 max-w-fit hover:scale-110"
